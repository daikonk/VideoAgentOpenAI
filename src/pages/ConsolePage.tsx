  ...
  useEffect(() => {
    ...
    client.on('realtime.event', async (realtimeEvent: RealtimeEvent) => {
      if (realtimeEvent.event.type === 'response.done') {
        console.log(realtimeEvent.event.response.output[0].content[0].text);
        if (!avatar.current) {
        ...
        await avatar.current.speak({
          text: realtimeEvent.event.response.output[0].content[0].text,
        ...
        <div className="content-logs">
          <div className="content-block events">
            ...
            <div style={containerStyle}>
              {isLoading ? (
                <div style={loaderContainerStyle} className="absolute">
